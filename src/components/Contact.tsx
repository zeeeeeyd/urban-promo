        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="group flex items-start space-x-4 p-6 bg-white border border-gray-200 hover:border-yellow-400/50 hover:shadow-lg transition-all duration-300 rounded-lg">
            ...
            <div className="pt-6">
              <button
                ...
                className="group flex items-center space-x-3 bg-gradient-to-r from-yellow-400 to-yellow-500 text-white px-8 py-3 font-semibold transition-all duration-300 hover:shadow-xl hover:shadow-yellow-400/25 hover:scale-105 rounded-lg"
              >
            ...
            <div className="bg-white p-8 border border-gray-200 shadow-lg rounded-lg">
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full group flex items-center justify-center space-x-3 bg-gradient-to-r from-yellow-400 to-yellow-500 text-white px-8 py-4 font-semibold transition-all duration-300 hover:shadow-xl hover:shadow-yellow-400/25 hover:scale-105 rounded-lg"
                  >
